package com.toutiao.officedict.annotation.config;

import com.toutiao.officedict.common.commonmodel.BaseEntity;
...
public class InsertUpdateInterceptor {
    @Pointcut("execution(* com.toutiao.officedict.dao..*.*(..))")
